export const en = {
  ...
  howDoesItWorkMetaTile:
    "Online Remote Interpreting 2023",
  ...
  remoteInterpretersDistance_pageTitle:
    "Professional remote interpreters",
  ...
  servicesMicrosoftteams_Heropara: "Are you planning to organize an online conference on Microsoft Teams and need the assistance of language interpreters? We have the solution for you at Rafiky.",
  ...
  teamsIntegration_Firstcard_para: "By simplifying timing, planning, and operations management, you can participate in any type of event without leaving your home or workplace.",
  teamsIntegration_Seccard_Heading: "0 SWITCHING COSTS",
  teamsIntegration_Seccard_para: "Continue using your preferred platform by integrating Remote Interpretation Service with Rafiky. No transition costs!",
  teamsIntegration_Thirdcard_Heading: "COST SAVINGS",
  teamsIntegration_Thirdcard_para: "Eliminating the costs associated with traditional interpretation (from renting translation equipment to interpreter travel and accommodation expenses) will contribute to a cost savings of over 80% without compromising service quality.",
  teamsIntegration_Forthcard_Heading: "PRE-EVENT TEST",
  teamsIntegration_Forthcard_para: "To ensure the best user experience, shortly before the start of the event, speakers and participants will conduct a free test using Rafiky integrated with the desired platform.",
  teamsIntegration_Fifthcard_Heading: "TECHNICAL SUPPORT",
  teamsIntegration_Fifthcard_para: "Our technicians will provide specialized technical support throughout the event.",
  teamsIntegration_Sixthcard_Heading: "QUALIFIED INTERPRETERS",
  teamsIntegration_Sixthcard_para: "Experienced interpreters with prior experience with integrated systems at your service. - Professionalism - Experience - Knowledge of systems",
  ...
  teamsIntegration_Eightcard_para: "The world's best interpreters at your disposal, crystal-clear audio, and high-definition video streaming for a unique experience with minimal effort.",
...
(If interpretation services are also required, a training session for interpreters will be provided as well)`,
 ...
 no matter where they are in the world, are capable of translating any type of message into the target language. Additionally, the live chat feature allows interpreters to have conversations during breaks and/or make specific requests during the event.`,
  ...
  remoteInterpreting_para: "Organizing an online event is not an easy task, whether it involves promoting activities or products, conducting interviews, hosting workshops, webinars, or online courses.",
  remoteInterpreting_paraOne: "You need to define objectives and strategies, create work plans, agendas, and questionnaires, take care of collateral marketing and participant management, all while not neglecting the technical aspects.",
  remoteInterpreting_paraTwo: "The team at our remote interpreting agency will take care of every aspect of your online event, providing a comprehensive 360-degree unique experience.",
  ...
  //Interpretation Services
  interpretationServices_HeadingChinese: "Interpretation services in Chinese and Lis",
  interpretationServices_HeadingRussia: 'Interpretation services in Russian and sign language',
  interpretationServices_para:
...
Rafiky enables the utilization of remote simultaneous interpretation (RSI) simply through smartphones, tablets, or computers, in any language and in real-time, reducing costs and ensuring the excellence of a consistently high-quality service, just like traditional interpretation but without the cumbersome translation booths and the related setup and dismantling costs and time required.`,
  ...
  fuzianaVideoparaTwo: 'No matter where they are in the world, professional and qualified online interpreters will be able to translate any type of message into the target language. In addition, the live chat feature allows the online interpreter to have conversations during breaks or make specific requests during the event.',
  ...
  LaChallengeFirstPara: 'Participants arranged in 8 different rooms. Participants connected via streaming in various virtual rooms.',
  LaChallengeSecHeading: '80 interpreters',
  LaChallengeSecPara: 'Remote simultaneous interpretation in 40 languages! A team of interpreters located in different parts of the world.',
  LaChallengeThirdHeading: '5 language combinations per room',
  LaChallengeThirdPara: 'Each room requires simultaneous translation in 5 languages.',
  ...
  rafikyConnectsubtHeading: 'REMOTE SIMULTANEOUS INTERPRETATION AND RAFIKY CONNECT',
  rafikyConnectfirstHeading: 'The easiest way to experience high-quality remote simultaneous interpreting services',
  rafikyConnectpara: 'With Rafiky, you can now set up a virtual conference room, anywhere and at any time: no bulky hardware is needed! We combine the power of cloud technology with modern devices to enhance your remote simultaneous interpretation experience!',

  connectServiceheadingOne: `Business Meetings`,
  connectServiceparaOne: 'Multi-lingual meetings with foreign partners – simultaneous remote interpreting. Possibility to have up to 30 participants connected simultaneously. Possibility to record meetings. Technical support included in the package.',
  ...
  connectServiceparathree: 'Presentation of content on your screen. Video streaming.  Different rooms for each conference with fragmentation of topics. Text communication via chat. Creation and presentation of quizzes and questionnaires.',
  connectServiceheadingfour: 'Press conferences',
  connectServiceparafour: 'Wide choice of position for speakers and participants. Global participation. Flexible number of participants Moderation of journalists’ questions. Conference recording. No special technical requirements.',
  ...
  novartisFirstPara: 'Participants arranged in 8 different rooms. Participants connected via streaming in various virtual rooms.',
  novartisSecPara: 'Streaming event in 8 languages! A team of interpreters located in different parts of the world.',
  novartisThirdPara: 'Each room requires simultaneous translation in 8 languages.',
  novartisFourthPara: 'Only 48 hours of time to organize all necessary aspects.',
  ...
  volksVeganFirstPara: 'Participants located in 8 different rooms. Participants connected via streaming in various virtual rooms.',
  volksVeganSecPara: 'Streaming event in 4 languages! A team of interpreters located in different parts of the world.',
  volksVeganThirdPara: 'Each room requires simultaneous translation in 4 languages.',
  volksVeganFourthPara: 'Only 96 hours to organize all necessary aspects.',


  volksVageHeading: 'Results',
  volksVagepara: 'After finalizing the event details and determining the number of participants, the Rafiky team conducted an online demonstration of the software.',
  volksVagepara2: 'Each participant received access credentials to the platform and detailed instructions on how to join the event remotely.',
  ...
  volksVagepara4: 'The simplicity of communication impressed the client: the participants themselves experienced the user-friendly software, clear audio, and quality interpreting service firsthand.',
  volksVageQuote: '"The convenience of the software is extraordinary. It only takes a few simple steps to enjoy a quality service from your smartphone. Thanks to Rafiky for providing us with a truly unique service."',


  caseStudyNovartis_Heading: 'THE CHALLENGE',
  firstColorHeadingLaChallengeRedBull: 'The Client',
  caseStudyRedBull_subHeading1: 'Remote Simultaneous Interpretation for Red Bull',
  caseStudyRedBull_para1: 'Inspired by functional drinks in the Far East, Dietrich Mateschitz creates an extremely innovative product that reflects a unique marketing concept. In the mid-1980s, a product was born that is now appreciated worldwide by athletes, sports enthusiasts, professionals, and students.',
  caseStudyRedBull_para2: 'As a global leader in developing innovative drugs in key therapeutic areas, in the production and commercialization of generic and biosimilar drugs, Novartis welcomed Advanced Accelerator Applications (AAA), a company specialized in radiopharmaceuticals, into its organization in 2018.',
  caseStudyRedBull_para3: 'For many years, Rafiky has been a faithful partner to Red Bull in organizing major international events.',
  secondColorHeadingLaChallengeRedBull: 'Sometimes the simplest solutions are the most effective.',
  caseStudyRedBull_para4: 'A revolutionary remote interpretation software that combines practicality, quality, and efficiency.',
  caseStudyRedBull_para5: 'The agenda included not only an initial presentation in the main event room but also a series of discussions in smaller rooms adjacent to the main hall. Each room required 5 different language combinations.',
  caseStudyRedBull_para6: 'Installing multiple interpretation booths in each room was not practical, but the audience was diverse, and the message had to reach all participants, regardless of their language.',
  ...
  firstColorHeadingLaChallengeRedBull: 'The Client',
  caseStudyVolksvagen_subHeading1: 'Remote Simultaneous Interpreting for Volkswagen',
  caseStudyVolksvagen_para1: 'An established commercial entity that needs no introduction.',
  caseStudyVolksvagen_para2: 'Born in the 1930s, the automotive company enjoys an unparalleled reputation today.',
  ...
  secondColorHeadingVolksVegan: 'Cutting-Edge Technology in the Interpreting Industry',
  caseStudyVolksvagen_para4: 'A revolutionary remote interpreting software that combines practicality, quality, and efficiency.',
  caseStudyVolksvagen_para5: 'Raﬁky allows for remote simultaneous interpretation (RSI) through smartphones, tablets, or computers in any language and in real-time, reducing costs and ensuring the excellence of a consistently high-quality service, just like traditional interpreting but without the bulky translation booths and the associated costs and setup/teardown times.',
  caseStudyVolksvagen_para6: 'All you need is a device (PC, laptop, or smartphone) with a good internet connection to access professional interpreting services with immediate communication between speakers of different languages.',


  mainTitleRedBull: 'Remote Simultaneous Interpretation - Red Bull',
  caseStudyRedBull_paraMain: 'In order to present company updates in light of their achieved results, Red Bull periodically holds globally important congresses and conventions. The latest major project that required the technical support of Rafiky involved a rich agenda consisting of presentations, product demonstrations, various debate sessions, and, of course, international guests. A reliable remote simultaneous interpretation service was exactly what they needed.',
  risultatiHeading: 'Results',
  risultatipara: 'After conducting all the necessary tests the day before the event, the Raﬁky team deployed all the resources necessary to ensure the success of the event.',
  risultatipara2: 'Today, we are proud to have provided support to Novartis in organizing such an important global event, and to continue every day, thanks to this strong collaboration, to put our platform at the service of health.',
  risultatipara3: 'The success of the event was our success, and the satisfaction of the client our greatest reward.',
