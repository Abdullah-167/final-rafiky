      ...
      <div className="container">
        <div className=" py-20">
          ...
          <h3 className="text-base sm:text-[26px] font-medium text-white text-center pb-5">
              {t("servicesInterpret_SubTitle")}
            </h3>
            <h2 className="text-3xl sm:text-6xl md:text-[79px] text-white font-bold mx-auto max-w-[1060px] text-center leading-[1.2em] pb-12">
              {t("servicesInterpret_Title")}
            </h2>
           
            <p className=" text-[20px] font-medium text-white mx-auto max-w-[850px] text-center pb-5">
              {t("servicesInterpret_para1")}
            </p>
            <p className=" text-[20px] font-medium text-white mx-auto max-w-[850px] text-center pb-10">
             {t("servicesInterpret_para2")}
            </p>
          </div>
