  ...
  return (
    ...
    >
      <div className="container">
        <div>
          <div>
            <h3 className="text-2xl text-black font-bold text-center pt-10 pb-8 leading-1">
              {t("rafikyServices_prontoSubTitle")}
            </h3>
            <h2 className="text-[35px] sm:text-[50px] text-black font-bold text-center mx-auto pb-12 lg:leading-10">
              {t("rafikyServices_prontoTitle")}
            </h2>
          </div>

          <div className="flex justify-center">
            <Button
              text={t("rafikyServices_prontoBtn")}
              color={"white"}
