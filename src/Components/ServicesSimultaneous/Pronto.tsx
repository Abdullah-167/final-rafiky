        ...
        <div>
          <div>
            <h5 className="text-2xl text-black font-bold text-center pt-10 pb-8 leading-1">
              {t("servicesSimultaneousInterpretation_prontoSubTitle")}
            </h5>
            <h2 className="text-[35px] sm:text-[50px] text-black font-bold text-center mx-auto pb-12 lg:leading-10">
              {t("servicesSimultaneousInterpretation_prontoTitle")}
            </h2>
          </div>

          <div className="flex justify-center">
            <Button
              text={t("servicesSimultaneousInterpretation_prontoBtn")}
              color={"white"}
